...
const Home = () => {
  ...
  return (
    // 🔥 GLOBAL OFFSET FOR FIXED NAVBAR (adjust height if needed)
    <div className="w-full flex flex-col overflow-x-hidden bg-white pt-[80px]">

      {/* ================= HERO SECTION ================= */}
      <section className="relative w-full h-[calc(100vh-80px)] overflow-hidden group">
        ...
        {/* SLIDER DOTS */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex gap-2 bg-white/10 backdrop-blur-xl px-5 py-2 rounded-full border border-white/20">
